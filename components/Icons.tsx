...
export const ScanIcon: React.FC<IconProps> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5a3 3 0 0 0-3 3v1.5M17.25 4.5a3 3 0 0 1 3 3v1.5M3.75 19.5a3 3 0 0 1-3-3v-1.5m16.5 4.5a3 3 0 0 0 3-3v-1.5M3 12h18" />
  </svg>
);
...
export const DashboardIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="m2.25 12 .895 4.473a2.25 2.25 0 0 0 2.152 1.905H18.702a2.25 2.25 0 0 0 2.152-1.905L21.75 12M2.25 12a2.25 2.25 0 0 1 2.25-2.25h15a2.25 2.25 0 0 1 2.25 2.25M2.25 12v-2.25A2.25 2.25 0 0 1 4.5 7.5h15a2.25 2.25 0 0 1 2.25 2.25V12m-15 4.5a.75.75 0 0 0-.75.75v.008c0 .414.336.75.75.75h.008a.75.75 0 0 0 .75-.75v-.008a.75.75 0 0 0-.75-.75H7.5Z" />
    </svg>
);
